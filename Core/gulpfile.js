    ...
    css:
        {
            vendor:
                [
                    ...
                    path.join(__dirname, "bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css"),
                ],
            plugins:
                [
    ...
    js:
        {
            vendor:
                [
                    ...
                    path.join(__dirname, "bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"),
                ],
            plugins:
                [
