  ...
  getMapList = function() {
      ...
      $.getJSON( window.location.protocol + '//' + window.location.hostname + '/?controller=HospitalProvider&action=list' )
        .done(function(res) {
          getList(res);
          //results = res;
    ...
    $.each( getData, function( key, value ) {
      ...
      $.each(value, function(k, v) {
        ...
        var marker      = new google.maps.Marker({
            position: position,
            map: map,
            icon: '/website/static/images/icon-marker.png'
        });
